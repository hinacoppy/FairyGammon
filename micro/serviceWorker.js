...
const CACHE_NAME = "MicroGammon-v20211122";
const ORIGIN = (location.hostname == 'localhost') ? '' : location.protocol + '//' + location.hostname;

const STATIC_FILES = [
  ORIGIN + '/FairyGammon/micro/',
  ORIGIN + '/FairyGammon/micro/index.html',
  ORIGIN + '/FairyGammon/micro/manifest.json',
  ORIGIN + '/FairyGammon/micro/icon/favicon.ico',
  ORIGIN + '/FairyGammon/micro/icon/apple-touch-icon.png',
  ORIGIN + '/FairyGammon/micro/icon/android-chrome-96x96.png',
  ORIGIN + '/FairyGammon/micro/icon/android-chrome-192x192.png',
  ORIGIN + '/FairyGammon/micro/icon/android-chrome-512x512.png',
