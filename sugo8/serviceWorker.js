...
const CACHE_NAME = "Sugo8-v20211124";
const ORIGIN = (location.hostname == 'localhost') ? '' : location.protocol + '//' + location.hostname;

const STATIC_FILES = [
  ORIGIN + '/FairyGammon/sugo8/',
  ORIGIN + '/FairyGammon/sugo8/index.html',
  ORIGIN + '/FairyGammon/sugo8/manifest.json',
  ORIGIN + '/FairyGammon/sugo8/icon/favicon.ico',
  ORIGIN + '/FairyGammon/sugo8/icon/apple-touch-icon.png',
  ORIGIN + '/FairyGammon/sugo8/icon/android-chrome-96x96.png',
  ORIGIN + '/FairyGammon/sugo8/icon/android-chrome-192x192.png',
  ORIGIN + '/FairyGammon/sugo8/icon/android-chrome-512x512.png',
