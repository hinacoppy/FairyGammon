...
const CACHE_NAME = "ShortGammon-v20211122";
const ORIGIN = (location.hostname == 'localhost') ? '' : location.protocol + '//' + location.hostname;

const STATIC_FILES = [
  ORIGIN + '/FairyGammon/short/',
  ORIGIN + '/FairyGammon/short/index.html',
  ORIGIN + '/FairyGammon/short/manifest.json',
  ORIGIN + '/FairyGammon/short/icon/favicon.ico',
  ORIGIN + '/FairyGammon/short/icon/apple-touch-icon.png',
  ORIGIN + '/FairyGammon/short/icon/android-chrome-96x96.png',
  ORIGIN + '/FairyGammon/short/icon/android-chrome-192x192.png',
  ORIGIN + '/FairyGammon/short/icon/android-chrome-512x512.png',
