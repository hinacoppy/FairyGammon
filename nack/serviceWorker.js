...
const CACHE_NAME = "NackGammon-v20211122";
const ORIGIN = (location.hostname == 'localhost') ? '' : location.protocol + '//' + location.hostname;

const STATIC_FILES = [
  ORIGIN + '/FairyGammon/nack/',
  ORIGIN + '/FairyGammon/nack/index.html',
  ORIGIN + '/FairyGammon/nack/manifest.json',
  ORIGIN + '/FairyGammon/nack/icon/favicon.ico',
  ORIGIN + '/FairyGammon/nack/icon/apple-touch-icon.png',
  ORIGIN + '/FairyGammon/nack/icon/android-chrome-96x96.png',
  ORIGIN + '/FairyGammon/nack/icon/android-chrome-192x192.png',
  ORIGIN + '/FairyGammon/nack/icon/android-chrome-512x512.png',
