...
const CACHE_NAME = "BackGammon-v20211122";
const ORIGIN = (location.hostname == 'localhost') ? '' : location.protocol + '//' + location.hostname;

const STATIC_FILES = [
  ORIGIN + '/FairyGammon/normal/',
  ORIGIN + '/FairyGammon/normal/index.html',
  ORIGIN + '/FairyGammon/normal/manifest.json',
  ORIGIN + '/FairyGammon/normal/icon/favicon.ico',
  ORIGIN + '/FairyGammon/normal/icon/apple-touch-icon.png',
  ORIGIN + '/FairyGammon/normal/icon/android-chrome-96x96.png',
  ORIGIN + '/FairyGammon/normal/icon/android-chrome-192x192.png',
  ORIGIN + '/FairyGammon/normal/icon/android-chrome-512x512.png',
