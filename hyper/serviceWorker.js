...
const CACHE_NAME = "HyperGammon-v20211122";
const ORIGIN = (location.hostname == 'localhost') ? '' : location.protocol + '//' + location.hostname;

const STATIC_FILES = [
  ORIGIN + '/FairyGammon/hyper/',
  ORIGIN + '/FairyGammon/hyper/index.html',
  ORIGIN + '/FairyGammon/hyper/manifest.json',
  ORIGIN + '/FairyGammon/hyper/icon/favicon.ico',
  ORIGIN + '/FairyGammon/hyper/icon/apple-touch-icon.png',
  ORIGIN + '/FairyGammon/hyper/icon/android-chrome-96x96.png',
  ORIGIN + '/FairyGammon/hyper/icon/android-chrome-192x192.png',
  ORIGIN + '/FairyGammon/hyper/icon/android-chrome-512x512.png',
